...
public class KhoanThuAdapter extends ArrayAdapter<KhoanThu> {
    ...
    ImageView imgDel_KhoanThu,imgiconkhoanthu;
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        imgiconkhoanthu = v.findViewById(R.id.imgiconkhoanthu);
        if (String.valueOf(it.getMaLoaiThu()).equals("1")){
            imgiconkhoanthu.setImageResource(R.drawable.luong);
        }
        if (String.valueOf(it.getMaLoaiThu()).equals("2")){
            imgiconkhoanthu.setImageResource(R.drawable.bitcoin);
        }
        if (String.valueOf(it.getMaLoaiThu()).equals("3")){
            imgiconkhoanthu.setImageResource(R.drawable.laibanhang);
        }
        if (!String.valueOf(it.getMaLoaiThu()).equals("1") && !String.valueOf(it.getMaLoaiThu()).equals("2") && !String.valueOf(it.getMaLoaiThu()).equals("3")){
            imgiconkhoanthu.setImageResource(R.drawable.ic_t);
        }
